...
const workflowTemplates: WorkflowTemplate[] = [
  ...
  {
    id: 'advanced-node-practice',
    name: '进阶节点练习',
    description: '不用外部 API，演示变量赋值、JSON 解析、循环、代码执行、文本模板和结果聚合。',
    input: '奶茶店新品活动',
    nodes: [
      {
        id: 'input-1',
      ...
      },
      {
        ...
        data: {
          kind: 'code',
          ...nodeMeta.code.defaults,
          label: '标题转大写',
          codeExpression: 'upper(title)',
      ...
      },
      {
        ...
        data: {
          ...
          label: '聚合最终结果',
          aggregateVariables: 'report\nplan_json',
          aggregateSeparator: '\n\n原始 JSON：\n',
          outputKey: 'advanced_result',
        },
      },
      {
        id: 'output-1',
        ...
        data: {
          ...
          ...nodeMeta.output.defaults,
          label: '练习输出',
          prompt: '{{advanced_result}}',
          outputKey: 'answer',
        },
      },
    ],
    edges: [
      { id: 'e-input-assign', source: 'input-1', target: 'assign-1', animated: true },
      { id: 'e-assign-title', source: 'assign-1', target: 'json-title' },
      { id: 'e-assign-tasks', source: 'assign-1', target: 'json-tasks' },
      { id: 'e-title-code', source: 'json-title', target: 'code-1' },
      { id: 'e-tasks-loop', source: 'json-tasks', target: 'loop-1' },
      { id: 'e-code-template', source: 'code-1', target: 'template-1' },
      { id: 'e-loop-template', source: 'loop-1', target: 'template-1' },
      { id: 'e-template-aggregate', source: 'template-1', target: 'aggregate-1' },
